 ...
 */
final class Version20191227232244 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick CHANGE date_add date_add DATETIME DEFAULT NULL, CHANGE date_update date_update DATETIME DEFAULT NULL, CHANGE groupe_id group_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick CHANGE date_add date_add VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE date_update date_update VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE group_id groupe_id INT DEFAULT NULL');
