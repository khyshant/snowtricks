...
final class Version20191209234645 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE group_trick ADD date_add DATETIME DEFAULT NULL, ADD date_upd DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick DROP date_add, DROP date_update');
    }
}
